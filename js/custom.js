...
for (let index = 0; index < slideItem.length; index++) {
    let html = `<button class="slide__dots-btn" data-slide='${index}'></button>`
...
inquireForm.addEventListener("submit", function (e) {
    ...
    $('.popup__message').animate({ right: 0 }, 800);
});
